...
1. Create the architecture diagram showing major components
2. Create the processing flow diagram from the main business flow
3. Create the dependency graph from the dependencies list
